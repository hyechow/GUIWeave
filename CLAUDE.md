...
- **DSL 编排器**(`core/orchestrator/`,browser 侧主战场):GUI 任务 = 脚本生成,交互 action 是对执行器的 FFI 调用。工具链地图见 `core/orchestrator/__init__.py` docstring;设计与决策记录见 `docs/milestone_as_function.md`。
