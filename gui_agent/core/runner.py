...
from gui_agent.core.content_store import (
    STITCH_OVERLAP_PX,
...
from gui_agent.core.run_context import (
...
from gui_agent.core.run_result import (
...
def main() -> None:
    from gui_agent.core.runner_cli import main as cli_main
