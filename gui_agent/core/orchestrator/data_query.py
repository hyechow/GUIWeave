...
def execute_data_query(
    ...
    *,
    ...
    """Run a restricted read-only SQL query over DOM table snapshots.
    ...
    Column names are normalized to snake_case identifiers, e.g. "Customer Email"
    becomes `customer_email`.
    """
