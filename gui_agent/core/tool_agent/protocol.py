...
def worker_attempt_contract(
    ...
    *,
    ...
    profile_rules = (
        ...
        "rest of its card need not be revealed. Complete immediately; never scroll or page "
        "farther after the boundary is proved.\n"
        ...
        "exact unresolved row. While `candidate_records < known_total`, load more "
        "candidates instead of declaring completion.\n"
