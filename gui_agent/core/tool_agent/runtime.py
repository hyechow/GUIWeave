...
class ToolAgentRuntime:
                    ...
                    if blocked_reason:
                        ...
                        feedback = {
                            ...
                            "instruction": (
                                ...
                                "retry the blocked action. Use another allowed action in the "
                                "current WorkerSpec or fail with the concrete blocker."
                            ),
                        }
                        self._trace(
    ...
    def _worker_system_prompt(
        ...
        prompt += (
            ...
            "schemas. `goal` and its acceptance/data contract are immutable; `strategy` "
            "is the current Master-selected physical approach. Execute that strategy "
            "without weakening the goal or inventing a replacement path.\n"
