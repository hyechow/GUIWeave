...
`{"diagnosis":{"kind":"approach_disproved|transient_failure|state_conflict|blocked|exhausted","evidence_refs":[],"reason":"..."},"recommendation":{"decision":"resume|reconcile_state|revise_approach|escalate_to_master|stop","approach":null,"preserve_progress":true,"invalidate":[]}}`
...
- Always preserve progress. `invalidate` may cite only supplied audit refs and is advisory; Runtime validates it.
