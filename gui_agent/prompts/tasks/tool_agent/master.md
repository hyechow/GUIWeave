...
- Every data requirement declares `id`, `description`, `row_schema`, `field_sources`, `field_types`, `filters`, and `coverage`; `target_label` is optional, and `data_requirements` is always a list.
