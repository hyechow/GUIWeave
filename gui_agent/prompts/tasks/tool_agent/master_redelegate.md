...
- Keep the same requirement meaning, normalized row schema, field sources, field types, requirement ID, cardinality, and coverage contract so the original program and deterministic transforms remain valid.
