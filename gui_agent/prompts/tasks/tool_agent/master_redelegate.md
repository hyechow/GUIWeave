...
- Preserve the goal, success criteria, collector/operator profile, and every downstream data contract field identified as immutable in the input. The Runtime rejects semantic or schema drift.
